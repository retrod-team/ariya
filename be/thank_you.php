...
if(isset($_SESSION['payAtHotel']) && $_SESSION['payAtHotel'] == '1'){
...
<body>
    ...
    <?php
        ...
        if($_POST['status'] == 'success' || $_SESSION['payAtHotel'] == '1'){
            $boid = $_SESSION['OID'];
            ...
            $bid = isset($_POST['txnid'])? $_POST['txnid'] : $bid; 
             
             $email = isset($_POST['email'])? $_POST['email'] : $email;
             
             $payid =  isset($_POST['easepayid'])? $_POST['easepayid'] : ''; 
