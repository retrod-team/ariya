...
if(isset($_GET['update'])){
    ...
    if(mysqli_num_rows($sql) > 0){
        ...
        $mrp = $update_row['mrp'];
        $roomDesc = $update_row['description'];
        $btn = 'Update Room';
    }else{
                            ...
                            <!-- <a href="<?php echo FRONT_BOOKING_SITE.'/admin/list-room.php' ?>" class="btn dark mb15">Manage Room</a> -->
                                ...
                                <form action="" id="manageForm" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form_group mb-3">
                                        <label for="roomDescField">Room Description</label>
                                        <textarea rows="4" cols="50" class="form-control" id="roomDescField" placeholder="Enter Room Description" name="roomdesc"><?= $roomDesc ?></textarea>
                                    </div>
