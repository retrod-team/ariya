                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p0" style="align-items: end;">
                                    ...
                                    <div class="form_group col-md-6 mb-3">
                                        ...
                                        <input required type="text" name="category" id="category" placeholder="Enter Category" class="form-control" value="<?php echo $category ?>">
                                    </div>
                                    ...
                                    <div class="form_group col_12 mb-3">
                                        ...
                                        <textarea class="form-control" name="Desc" id="Desc" ><?php echo $Desc ?></textarea>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-items-center mb-0">
                                        <tr>
                                            ...
                                            <th width="250px" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"></th>
                                        </tr>
                                        <tr>
                                            <?php
                                                ...
                                                while($imgrow = mysqli_fetch_assoc($sql)){
                                                    $img = FRONT_SITE_IMG.'post/'.$imgrow['img'];
                                                    $id = $imgrow['id'];
                                                    $si ++;
                                                    echo '
                                                        <tr>
                                                            <th class="mb-0 text-xs"><img style="width: 80px;" src="'.$img.'"></th>
                                                            <th class="mb-0 text-xs">'.$imgrow['title'].'</th>
                                                            <th class="mb-0 text-xs">'.$imgrow['category'].'</th>
                                                            <th class="mb-0 text-xs"><small style="width: 250px;overflow: hidden;display: inline-block;word-break: break-all;">'.$imgrow['description'].'</small></th>
                                                            <th class="mb-0 text-xs">
                                                                ...
                                                                <div class="tableCenter">
                                                                    ...
                                                                    <a class="tableIcon update bg-gradient-info" href="blog.php?update='.$id.'" style="margin-right:10px" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit"><i class="far fa-edit"></i></a>
                                                                    <a class="tableIcon delete bg-gradient-danger" href="blog.php?delete='.$id.'" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete"><i class="far fa-trash-alt"></i></a>
                                                                    </span>
                                                                </div>
                                                            </th>
                                                        </tr>
