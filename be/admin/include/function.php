...
function inventoryRateUpdate($updateId, $updateDId, $price='',$price2='',$date, $child,$adult){
    ...
    $existQuery = mysqli_query($conDB, "select * from inventory where  room_id='$updateId' and room_detail_id='$updateDId'  and add_date = '$date'");
        if(mysqli_num_rows($existQuery) > 0){
            $sql= "update inventory set $priceUpade $priceUpade2 eAdult='$adult', eChild='$child' where  room_id='$updateId' and room_detail_id='$updateDId' and add_date = '$date'";
...
function getSlider($sid='',$page=''){
    global $conDB;
    $sql = "select * from herosection where id!=''";
    if($sid != ''){
        $sql .= " and id = '$sid'";
    }
    if($page != ''){
...
$testimonialArr = [
    ...
    [
        'img'=> '04.png',
        'name'=> "AYUSA MALIK",
        'des'=> 'Conference hall and food are good for meetings',
        'addOn'=>'2022-04-24'
    ],
    ...
    [
        'img'=> '05.png',
        'name'=> "AB kathar",
        'des'=> 'Good service and best exprnc i ever travel',
        'addOn'=>'2022-04-12'
    ],
    
    [
        'img'=> '06.png',
        'name'=> "Gireesh Shrotriya",
        'des'=> 'Nice and place to stay. Locatdd in main market place, better conected to Bhuvneshwar Air Port and rail way stations.',
        'addOn'=>'2022-04-01'
    ],
    
    [
        'img'=> '07.png',
        'name'=> "REBELCOMBAT'S ARENA",
        'des'=> 'Very nice place it is a good palace to hold wedding and ceremony',
        'addOn'=>'2022-03-24'
    ],
