...
if(isset($_POST['type'])){
                ...
                <?php
                    ...
                    foreach($_SESSION['room'] as $key=>$val){
                                            ...
                                            <div id="room_summary">
                                                ...
                                                <div class="room_summary_box">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><span><strong>Room Price:</strong> </span> <span>Rs <strong><?php 
                                                        ...
                                                        <li>
                                                            ...
                                                            <span><strong>Adults: <?php echo $singleRoomPriceCalculator[0]['adultPrint']; ?></strong></span>  <span>Rs <strong><?php
                                                        ...
                                                        <li>
                                                                ...
                                                                <span><strong>Child: <?php echo $singleRoomPriceCalculator[0]['childPrint'];  ?></strong></span> <span>Rs<strong> <?php
                                                        ...
                                                        <?php 
                                                            ...
                                                            if($singleRoomPriceCalculator[0]['couponCode'] != ''){
                                                                ...
                                                                echo '
                                                                    ...
                                                                    <li><span><strong>Coupon ( '.$couponPer.'  ):</strong></span> <span id="gstPrint">- Rs '.$couponPrice.'</span></li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span><strong>GST ( <?php echo $singleRoomPriceCalculator[0]['gstPer'] ?>% ):</strong></span> <span id="gstPrint">Rs <strong class="updateRoomGst <?php echo $key ?>"><?php echo $singleRoomPriceCalculator[0]['gst'] ?></strong></span>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span><strong>Total:</strong></span> <span >Rs <strong class="updateRoomTotalPrice <?php echo $key ?>"><?php echo $singleRoomPriceCalculator[0]['total'] ?></strong></span>
                        ...
                        <ul>
                            ...
                            <li id="pickupContent" style="display:none;justify-content: space-between;"></li>

                             <li id="payathotelContent" style="display:none;justify-content: space-between;"></li>
                        ...
                        <div class="room-services"><br></div>
                                ...
                                <div style="display: inline-block;margin-bottom: 15px;">
                                        ...
                                        <?php
                                            ...
                                            $payAtHotel = settingValue()['payAtHotel'];

                                            if($payAtHotel == 1){

                                                $_SESSION['payAtHotel'] == 'Yes';

                                                $select = '';

                                                if(isset($_SESSION['payAtHotel']) && $_SESSION['payAtHotel'] == 'Yes'){

                                                    $select = 'checked';

                                                }

                                                echo '  <div class="payAtHotel">

                                                            <input type="checkbox" name="payAtHotel" '.$select.' id="payAtHotel">

                                                            <label for="payAtHotel">Pay At Hotel <span class="tool" data-tooltip="'.$payAtHotel.'"> <i class="far fa-question-circle"></i></span></label>
    ...
    if($type == 'persionCheckout'){
        ...
        $sql = "insert into booking(bookinId,name,email,phone,company_name,comGst,payment_status,add_on,partial,couponCode,pickUp,grossCharge,userPay,payAtHotel) values('$bid','$personName','$personEmail','$personPhoneNo','$companyName','$companyGst','pending','$add_on','$partial','$couponCode','$pickUp','$grossAmount','$userPay','$payAtHotel')";
        ...
        if(!empty($personName)){
            ...
            if(isset($_SESSION['room'])){
                ...
                foreach($_SESSION['room'] as $key=>$val){
                    ...
                    $sql = "insert into bookingdetail(bid,roomId,roomDId,adult,child,night,checkIn,checkout,roomPrice,adultPrice,childPrice,gstPer,totalPrice) values('$bid','$rid','$rdid','$adult','$child','$night','$checkInTime','$checkInOut','$roomPrice','$adultPrice','$childPrice','$gstPer','$total')";
                ...
                // $_SESSION['title']= getRoomNameById($room_id)." Booking";

                // $_SESSION['desc']= getRatePlanByRoomDetailId($room_detail_id);
    ...
    if($type == 'payAtHotel'){
        ...
        $_SESSION['payAtHotel'] = 1;

    }



    if($type == 'removePayAtHotel'){
