    ...
    <div class="footer_content">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="caption">
                        <div class="logo" style="width: 120px; margin-bottom: 10px;"><a href="<?= hotelDetail()['url'] ?>" target="_blank"><img src="<?= FRONT_SITE_IMG.hotelDetail()['logo'] ?>" alt="<?php echo hotelDetail()['name'] ?> logo"></a></div>
                ...
                <div class="col-md-4">
                    <div class="booking_detail">
                        ...
                        <br/>
                        <ul class="social">
                            <li style="display: inline-block;"><a href="<?= hotelDetail()['fb-link']?>" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                            <li style="display: inline-block;"><a href="<?= hotelDetail()['in-link']?>" target="_blank"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3">
...
s1.async=true;
s1.src='https://embed.tawk.to/637f4237b0d6371309d0da23/1gikhlbst';
s1.charset='UTF-8';
